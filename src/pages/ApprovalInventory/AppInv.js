              ...
              <div className='approval-inv-list-card'>
                {appData.length === 0 ? (
                  <p>Not request</p>
                    ...
                    appData.map((data) => (
                        <div className='approval-inv-list-box-item' key={data.po_id} onClick={()=>
                        handleClickApproval(data.po_id, data.ToUser, data.Jabatan, data['Kode Wilayah'], data['Jenis Produk'])}>
